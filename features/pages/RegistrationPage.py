...
class RegistrationPage(BasePage):
    ...
    def set_city(self, city):
        self.driver.find_element(RegistrationPageLocators).send_keys(city)

    def set_random_state(self):
        self.driver.find_element(RegistrationPageLocators.STATE).select_by_index(random.randrange(1, 50))

    def set_country(self):
        self.driver.find_element(RegistrationPageLocators.COUNTRY).select_by_visible_text("United States")
    ...
    def register(self, title, name, last_name, password, address, city, phone):
